...
export class ConnectionManagementService extends Disposable implements IConnectionManagementService {
	...
	public saveProfileGroup(profile: IConnectionProfileGroup): Promise<string> {
		TelemetryUtils.addTelemetry(this._telemetryService, TelemetryKeys.AddServerGroup, this.logService);
		return new Promise<string>((resolve, reject) => {
	...
	private addTelemetryForConnection(connection: ConnectionManagementInfo): void {
		TelemetryUtils.addTelemetry(this._telemetryService, TelemetryKeys.DatabaseConnected, this.logService, {
	...
	private addTelemetryForConnectionDisconnected(connection: IConnectionProfile): void {
		TelemetryUtils.addTelemetry(this._telemetryService, TelemetryKeys.DatabaseDisconnected, this.logService, {
	...
	public changeGroupIdForConnectionGroup(source: ConnectionProfileGroup, target: ConnectionProfileGroup): Promise<void> {
		TelemetryUtils.addTelemetry(this._telemetryService, TelemetryKeys.MoveServerConnection, this.logService);
	...
	public changeGroupIdForConnection(source: ConnectionProfile, targetGroupId: string): Promise<void> {
		...
		TelemetryUtils.addTelemetry(this._telemetryService, TelemetryKeys.MoveServerGroup, this.logService);
	...
	public deleteConnection(connection: ConnectionProfile): Promise<boolean> {
		...
		TelemetryUtils.addTelemetry(this._telemetryService, TelemetryKeys.DeleteConnection, this.logService, {}, connection);
	...
	public deleteConnectionGroup(group: ConnectionProfileGroup): Promise<boolean> {
		TelemetryUtils.addTelemetry(this._telemetryService, TelemetryKeys.DeleteServerGroup, this.logService);
