...
export const IConnectionStoreService = createDecorator('connectionStoreService');

export interface IAddSavedPasswordResponse {
...
export class ConnectionStoreService implements IConnectionStoreService {
	...
	public addSavedPassword(credentialsItem: IConnectionProfile): Promise<IAddSavedPasswordResponse> {
