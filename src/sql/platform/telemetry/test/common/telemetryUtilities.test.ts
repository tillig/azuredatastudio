...
import { TestTelemetryService } from 'sql/platform/telemetry/test/common/testTelemetryService';
...
suite('SQL Telemetry Utilities tests', () => {
	...
	setup(() => {
		telemetryService = TypeMoq.Mock.ofType(TestTelemetryService, TypeMoq.MockBehavior.Strict);
